...
new_component = '''const HeroScrollAnimation = () => {
  ...
  return (
    <>
      {/* MOBILE HERO (Video, 80dvh height, static text) */}
      <section id="home-mobile" className="md:hidden h-[80dvh] bg-[#111111] text-white relative w-full">
          ...
          <main className="relative z-20 flex-1 flex flex-col justify-center px-6 w-full mt-24 mb-10 pointer-events-none">
            <div className="w-full pointer-events-auto">
              ...
              <div className="flex flex-col gap-4 mb-8">
                <div className="flex items-center gap-3 border border-white/10 bg-black/40 rounded-xl px-4 py-2 backdrop-blur-sm">
      ...
      <section ref={containerRef} id="home-desktop" className="hidden md:block h-[250vh] bg-[#111111] text-white relative w-full">
        <div className="sticky top-0 h-[100dvh] overflow-hidden flex flex-col w-full">
          ...
          <main className="relative z-20 flex-1 flex flex-col justify-center max-w-[1400px] mx-auto px-10 w-full mb-10 pointer-events-none">
            ...
            <div className="absolute bottom-6 right-8 flex items-center gap-2 scale-100 origin-bottom-right">
...
if os.path.exists(path):
    ...
    # Re-insert Hero3D import specifically at the top if not present
    ...
    if start_idx != -1 and end_idx != -1:
        c = c[:start_idx] + new_component + c[end_idx:]
    else:
        print("Could not find bounds of HeroScrollAnimation")

    with open(path, 'w', encoding='utf-8') as f:
        f.write(c)
    print('Updated Hero into responsive layout')
